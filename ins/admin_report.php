...
// Build query for users who requested this inserto
$query = '
    SELECT DISTINCT u.id, u.username, u.area, u.dni, r.id as request_id, r.status, r.created_at, ri.cantidad
    FROM request_items ri
    JOIN requests r ON ri.request_id = r.id
    JOIN users u ON r.user_id = u.id
    WHERE ri.inserto_id = :ins_id
';
...
<head>
  <meta charset="utf-8">
  <title>Reporte - <?=htmlspecialchars($inserto['code'])?></title>
...
<body>
  ...
  <div class="container">
    <div class="page-header">
      <h1 class="page-title">Reporte de Uso: <?=htmlspecialchars($inserto['code'])?></h1>
      <p class="page-subtitle">Quién usó este inserto y cuándo</p>
    </div>
