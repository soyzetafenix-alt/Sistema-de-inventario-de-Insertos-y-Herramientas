...
// Build query: uso de la herramienta en solicitudes aceptadas
$query = '
  SELECT u.username, u.dni, u.area,
         r.id AS request_id,
         r.status,
         r.created_at,
         r.delivery_date,
...
<head>
  <meta charset="utf-8">
  <title>Historial de Uso Herramienta - <?=htmlspecialchars($tool['code'])?></title>
...
<body>
  ...
  <div class="container">
    <div class="page-header">
      <h1 class="page-title">Historial de Uso (Herramienta): <?=htmlspecialchars($tool['code'])?></h1>
      <p class="page-subtitle">Quién ha pedido esta herramienta y cuándo</p>
    </div>
    ...
    <div class="card">
      <h3 style="margin-bottom: 15px;">Registros (<?=count($rows)?>)</h3>
